function load_post_group_tables() {
    ...
    $.getJSON("../jsons//office_type.json", function(data) {
        ...
        function(data) {
            $.each(data, function(key, val) {
                ...
                tablekey = $("#" + key).DataTable({
                    ...
                    bProcessing: true,
                    ajax: {
                        url: "/build/api/office/office_group2.php",
                        method: "post",
                        data: function(d) {
                ...
                <a class="btn" id="print_dvices" target="blank" tabindex="0" data-placement="right" title="طباعه جرد المكتب" href="../../build/grd/?office_name=${row.office_name}">
