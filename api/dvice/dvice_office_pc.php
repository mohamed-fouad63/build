...
if ($_SESSION['db'] && !empty($_POST)) {
    ...
    $query_all_in_it = "SELECT num,id,office_name,dvice_type,dvice_name,sn,ip,pc_doman_name,building_name,note,note_move_to FROM dvice WHERE office_id = '$input_search' and id = 'pc' ";
