...
if ($_SESSION['db'] && !empty($_POST)) {
    ...
    $query_all_in_it = "SELECT dvice_name,COUNT(dvice_name) FROM dvice where id='other' AND dvice_type='$dvice_type' GROUP BY dvice_name ORDER BY `dvice`.`dvice_name` ASC";
