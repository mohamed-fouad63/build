<div class="modal fade" id="Add_Post_Office" tabindex="-1" aria-labelledby="EditModalLabel" aria-modal="true"
    role="dialog">
    <form action="">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control me-3 office_name_input_modals" id="office_name"
                            placeholder="اسم المكتب">
                        <span class="input-group-text  col-sm-2">مجموعه</span>
                        <input type="text" class="form-control post_group" id="post_group_input_modal"
                            placeholder="مجموعه" readonly="">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <textarea type="text" class="form-control address" id="address"
                ...
                <div class="modal-footer">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-primary" data-bs-dismiss=""
                            id="Add_Post_Office_btn">اضافه</button>
                    </div>
                </div>
            </div>
        </div>
