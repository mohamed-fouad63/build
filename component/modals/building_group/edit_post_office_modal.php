<div class="modal fade" id="Edit_Post_Office" tabindex="-1" aria-labelledby="EditModalLabel" aria-modal="true"
    role="dialog">
    <form action="">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control me-3 office_name_input_edit" id=""
                            placeholder="اسم المكتب" readonly>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" min="1" class="form-control me-3 money_code_input_edit"
                            id="edit_money_code" placeholder="كود مالى">
                        <span class="input-group-text  col-sm-2">كود بريدى</span>
                        <input type="number" min="1" class="form-control me-3 post_code_input_edit" id="edit_post_code"
                            placeholder="كود بريدى">
                        <span class="input-group-text  col-sm-2">كود بوستال</span>
                        <input type="number" min="1" class="form-control postal_code_input_edit" id="edit_postal_code"
                            placeholder="كود بوستال">
                    </div>
                    <div class="input-group mb-3">
                        ...
                        <span class="input-group-text  col-sm-2">التليفون</span>
                        <input type="text" class="form-control input_edit_tel" id="edit_tel"
                            placeholder="تليفون المكتب">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text  col-sm-2" id="basic-addon1">العنوان</span>
                        <textarea type="text" class="form-control input_edit_address" id="edit_address"
                ...
                <div class="modal-footer">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-primary" id="Edit_Post_Office_btn"
