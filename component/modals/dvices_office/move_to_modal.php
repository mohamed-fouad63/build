            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control me-3 dvice_name" id="move_to_dvice_name"
                            placeholder="نوع الجهاز" readonly>
                        <span class="input-group-text  col-sm-2">السريال</span>
                        <input type="text" class="form-control dvice_sn" id="move_to_dvice_sn" placeholder="السريال"
                            readonly>
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text  col-sm-2">من</span>
                        <input type="text" class="form-control me-3 office_name" id="move_to_office_name"
                            placeholder="من" readonly>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="date" class="form-control" id="move_to_date" value="<?php echo date('Y-m-d'); ?>"
                            placeholder="بتاريخ">
                    </div>
                    <div class="input-group mb-3">
